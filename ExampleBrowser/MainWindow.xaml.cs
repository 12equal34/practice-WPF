...
namespace ExampleBrowser
{
	...
	public partial class MainWindow : Window
	{
		...
		private void CreateThumbnail(Window window, int width, string path)
		{
		...
		{
			this.Examples.Clear();
			var examples = this.GetExamples(this.GetType().Assembly, searchTxt.Text).OrderBy(ex => ex.Title).ToArray();
